...
export default function PortalContent({ initialData }: PortalContentProps) {
  ...
  useEffect(() => {
    ...
    // Log para demonstrar que recebemos dados do ISR
    console.log('Dados iniciais do ISR:', initialData)
  }, [router, initialData])
